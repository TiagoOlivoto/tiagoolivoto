...
cropped <- image_autocrop(imgs_crop, edge = 30)
...
```{r export, eval=FALSE}
image_export(img, "img_exported2.jpg")

# ou para uma subpasta
image_export(img, "test2/img_exported.jpg")
```
...
```{r}
cob <- image_import("cob.jpg", plot = TRUE)
...
### Objetos pequenos
```{r}
wheat <- image_import("wheat.jpg", plot = TRUE)
analyze_objects(wheat)

vicia <- image_import("vicia2.jpg", plot = TRUE)
...
get_measures(af, id = 30, perimeter ~ 20)
```
