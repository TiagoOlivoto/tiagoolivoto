...
From now on it will be ridiculously simple to combine separate ggplots into the same graphic using operators (`+`) and (`/`) in metan. To access the new simply install the development version with
